...
//    private final JdbcTemplate jdbcTemplate;
    ...
    public BaseResp<Void> editPerson(PersonUpdateRequest req) {
        try {
            log.info("editPerson Start, id: {}", req.getId());
            ...
            log.error("editPerson Error, id: {}", req.getId(), e);
            return BaseResp.error(SystemCode.SYSTEM_ERROR);
        } finally {
            log.info("editPerson End");
        }
    }
    ...
    public BaseResp<Void> deletePerson(Long id) {
        log.info("deletePerson Start, id: {}", id);
        try {
            ...
            */
            ...
            log.error("deletePerson Error, id: {}", id, e);
            return BaseResp.error(SystemCode.SYSTEM_ERROR);
        } finally {
            log.info("deletePerson End, id: {}", id);
        }
    }
